...
#define INPUT_MAX_DATA 		40*2048
#define NOF_INPUT_ITF		1

//typedef _Complex float  output_t;
typedef char  output_t;		//_Complex float, float, int, char
#define OUT_TYPE			"CHAR"		//COMPLEXFLOAT, FLOAT, INT, CHAR
#define OUTPUT_MAX_DATA 	40*2048
