...
#include "CTRL_example2_interfaces.h"
#include "CTRL_example2_functions.h"
#include "CTRL_example2.h"

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="CTRL_example2";
int run_times=1;
...
int initialize() {
	...
	if (block_length > get_input_max_samples()) {
		...
		moderror("Check your CTRL_example2_interfaces.h file\n");
		return -1;
	}
	/*Include the file name and line number when printing*/
...
int work(input_t *inp, output_t *out) {
	...
	/* do CTRL here */
	// Send a flag 1 each Tslot multiple of 5
	if(Tslot%5==0){
		*out_char=0x00;
		printf("CTRL=0: Tslot=%d.........................................NOT TO SEND COMMAND\n", Tslot);
	}
	else{
		*out_char=0x01;
		printf("CTRL=1: Tslot=%d.........................................SEND COMMAND\n", Tslot);
	}
