...
int initialize() {
	...
	printf("\033[1;37;44m\tO--------------------------------------------------------------------------------------------O\t\033[0m\n");
	printf("\033[1;37;44m\tO    SPECIFIC PARAMETERS SETUP: %s						\t\033[0m\n", mname);
	printf("\033[1;37;44m\tO      Nof Inputs=%d, DataTypeIN=%s, Nof Outputs=%d, DataTypeOUT=%s	\t\033[0m\n", 
		       NOF_INPUT_ITF, IN_TYPE, NOF_OUTPUT_ITF, OUT_TYPE);
	printf("\033[1;37;44m\tO      block_length=%d, run_times=%d, sampligfreqHz=%3.3f				\t\033[0m\n", block_length, run_times, samplingfreqHz);
	printf("\033[1;37;44m\tO      MODE=%d, gain=%1.1f, SNR=%3.1fdBs							\t\033[0m\n", mode, gain, SNR);
	printf("\033[1;37;44m\tO--------------------------------------------------------------------------------------------O\t\033[0m\n");
	printf("\n");
