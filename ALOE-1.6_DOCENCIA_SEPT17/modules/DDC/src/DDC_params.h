...
extern param_t parameters[] = {
		...
		{"samplingfreqHz",STAT_TYPE_FLOAT,1},
		{"f0_freqHz",STAT_TYPE_FLOAT,1},
		{"gain",STAT_TYPE_FLOAT,1},
		{"Ninterpol",STAT_TYPE_INT,1},
		{"Ndecimate",STAT_TYPE_INT,1},
		{"filtercoefffile",STAT_TYPE_STRING,1},
