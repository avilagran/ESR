...
int send_dataSUBFRAME(_Complex float *inbuffer, _Complex float *outbuffer){
	
	int CPLENGTH[14] = {10, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9};
	
	int i = 0;
	int j, k, l;
	
	for (k = 1; k <= 14; k++) {
		j = k * 128 - CPLENGTH[k - 1];
		for (l = 0; l < CPLENGTH[k - 1]; l++) {
